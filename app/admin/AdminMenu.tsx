    ...
    <style>{`
      ...
      @media(max-width:700px){
        ...
        .admin-mobile-menu-button{
          display:flex;position:fixed;top:14px;left:14px;width:48px;height:48px;
          align-items:center;justify-content:center;border:2px solid #f5bf28;border-radius:13px;
          background:linear-gradient(135deg,#d90812,#98050b);color:#fff;font-size:25px;
          z-index:1002;box-shadow:0 8px 25px #0006;cursor:pointer
        }
        .admin-mobile-overlay{
          display:block;position:fixed;inset:0;background:#0009;z-index:1000;border:0
        }
        .admin-mobile-menu{
          display:flex;position:fixed;top:0;left:0;bottom:0;width:min(330px,88vw);
          flex-direction:column;padding:22px 14px;background:linear-gradient(180deg,#16070a,#09090b);
          color:#fff;z-index:1001;transform:translateX(-105%);transition:transform .25s ease;
          box-shadow:12px 0 35px #0009;overflow-y:auto
        }
        ...
        .admin-mobile-menu-header img{width:48px;height:48px;border-radius:50%;border:2px solid #f5bf28;object-fit:cover}
        .admin-mobile-menu-header b{color:#f5bf28;font-size:18px}
        .admin-mobile-item{display:flex;align-items:center;gap:13px;width:100%;padding:14px 13px;margin:2px 0;border:0;border-radius:10px;background:transparent;color:#ddd;text-align:left;font-size:14px;cursor:pointer}
        .admin-mobile-item:hover{background:#3b1116;color:#fff}
        .admin-mobile-item span:first-child{font-size:20px;width:25px;text-align:center}
