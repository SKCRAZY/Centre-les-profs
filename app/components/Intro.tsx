    ...
    <div className={`site-intro ${leaving ? "site-intro-leaving" : ""}`} aria-hidden="true">
      ...
      <style jsx>{`
        .site-intro {
          ...
          place-items: center;
          overflow: hidden;
          background: radial-gradient(circle at 50% 42%, #3b1015 0%, #16070a 35%, #070709 75%);
          animation: introIn .45s ease-out both;
        }
        .site-intro-leaving {
          animation: introOut .6s cubic-bezier(.7,0,.2,1) both;
          pointer-events: none;
        }
        .intro-glow {
          position: absolute;
          ...
          border-radius: 50%;
          background: radial-gradient(circle, #f5bf2838 0%, #d9081218 35%, transparent 70%);
          filter: blur(10px);
        ...
        .intro-content {
          ...
          align-items: center;
          text-align: center;
          animation: contentIn 1.15s cubic-bezier(.16,1,.3,1) both;
        }
        .intro-logo-wrap {
          ...
          padding: 7px;
          border-radius: 50%;
          background: linear-gradient(135deg, #ffe18a, #f5bf28 45%, #a96b00);
          box-shadow: 0 0 0 1px #ffe18a88, 0 0 45px #f5bf2866, 0 25px 70px #000b;
          animation: logoReveal 1.15s cubic-bezier(.16,1,.3,1) both;
        }
        .intro-logo {
          width: 100%;
          height: 100%;
        ...
        .intro-line {
          ...
          height: 2px;
          margin-top: 27px;
          background: linear-gradient(90deg, transparent, #f5bf28, transparent);
          animation: lineReveal .8s .55s ease-out forwards;
        }
        .intro-title {
          margin-top: 18px;
          color: #fff;
          ...
          animation: textReveal .8s .65s ease-out both;
        }
        .intro-subtitle {
          margin-top: 9px;
          color: #f5bf28;
          ...
          font-weight: 800;
          letter-spacing: .28em;
          animation: textReveal .8s .8s ease-out both;
        }
        ...
        @media (prefers-reduced-motion: reduce) {
          .site-intro,.site-intro-leaving,.intro-content,.intro-logo-wrap,.intro-line,.intro-title,.intro-subtitle,.intro-glow { animation: none !important; }
          .intro-line { width: min(260px,55vw); }
        }
      `}</style>
    </div>
  );
