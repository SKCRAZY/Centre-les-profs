  ...
  return (
    <div className={`site-intro ${leaving ? "site-intro-leaving" : ""}`} aria-hidden="true">
      ...
      <div className="intro-content">
        <div className="intro-logo-wrap"><img className="intro-logo" src="/logo.png" alt="" /></div>
      ...
      <style jsx>{`
        ...
        .intro-glow{position:absolute;width:min(70vw,650px);height:min(70vw,650px);border-radius:50%;background:radial-gradient(circle,#f5bf2838 0%,#d9081218 35%,transparent 70%);filter:blur(10px);animation:pulse 2.8s ease-in-out infinite}
